...
export function OccasionsSection() {
  ...
  return (
    <section id="occasions" className="scroll-mt-20 border-t border-border bg-secondary/25 py-16 sm:py-20">
      <div className="site-container">
        ...
        <div className="grid gap-10 sm:grid-cols-2">
          {items.map((item) => {
            ...
            return (
              <div key={item.titleKey} className="flex gap-4 border-b border-border/70 pb-8 last:border-0 sm:last:border-b">
